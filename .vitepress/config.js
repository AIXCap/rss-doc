...
export default defineConfig({
    ...
    zh: {
      ...
      themeConfig: {
        nav: [
          ...
          { text: '功能', link: '/zh/features/feed-sources' },
          { text: '政策', link: '/zh/policy/privacy-policy' },
          { text: '常见问题', link: '/zh/faq/product-faq' },
          { text: '关于', link: '/zh/about/about-us' },
        ],
        sidebar: [
          {
            text: '指南',
            items: [
              { 
                ...
                items: [
                  ...
                  { text: '缘于 AI', link: '/zh/guide/introduction/due-to-ai' },
          ...
          },
          {
            text: '功能',
            items: [
              { text: '订阅源', link: '/zh/features/feed-sources' },
          ...
          },
          {
            text: '定价',
            items: [
              { text: '免费版', link: '/zh/pricing/free' },
              { text: '专业版', link: '/zh/pricing/pro' }
            ]
          },
          {
            text: '政策',
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Features', link: '/features/feed-sources' },
      { text: 'Policy', link: '/policy/privacy-policy' },
      { text: 'FAQ', link: '/faq/product-faq' },
      { text: 'About', link: '/about/about-us' },
    ],
    ...
    sidebar: [
        ...
        items: [
          { 
            ...
            items: [
              ...
              { text: 'Due to AI', link: '/guide/introduction/due-to-ai' },
      ...
      },
      {
        text: 'Features',
        items: [
          { text: 'Feed Sources', link: '/features/feed-sources' },
      ...
      },
      {
        text: 'Pricing',
        items: [
          { text: 'Free', link: '/pricing/free' },
          { text: 'Pro', link: '/pricing/pro' }
        ]
      },
      {
        text: 'Policy',
